...
4. Change the `logo.png` and `default-social-image.png` in the `assets/` folder to your own branding
...
3. Create a `logo.png` and `default-social-image.png` in a new `assets/` folder
